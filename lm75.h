...
#define __LM75_ADDRESS_BASE = 0x90
...
#define __LM75_TEMPERATURE   0x00
#define __LM75_CONFIG        0x01
#define __LM75_ALARM_LOW     0x02
#define __LM75_ALARM_HIGH    0x03

#define __LM75_CONF_FAULTQUEUE_4  0b00010000
#define __LM75_CONF_POLARITY_Pos  2


/**
 *  \brief Driver to read data from LM75 temperature
 *  sensors. It has a trigger input and 2 outputs: temperature and alarm
 *  The trigger is used to synchronise the output - as LM75 has no internal
 *  event system for temperature
 */
class nBlock_LM75: public nBlockSimpleNode<1> {
public:
    /**
     ...
     *  
     */
    nBlock_LM75(PinName pinSDA, PinName pinSCL, int address, float alarmMin, float alarmMax, int comparatorPolarity, int scale);
